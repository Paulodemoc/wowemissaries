    ...
    public class MockDataStore : IDataStore<Faction>
    {
        ...
        public MockDataStore()
        {
            factions = new List<Faction>{
                ...
                new Faction { Name = "Dreamweavers", Icon="dreamweavers.jpg", Expansion="Legion", Tracked=false, ExpireOn=DateTime.MinValue },
                ...
                new Faction { Name = "Kirin Tor", Icon="kirintor.jpg", Expansion="Legion", Tracked=false, ExpireOn=DateTime.MinValue },
        ...
        private static async Task ReadLocalData()
        {
            try
            {
        ...
        async private void SaveLocalData()
        {
